        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Informasi <?=$anggota[0]['nickname'];?></h1>
          <p class="mb-4">Informasi lengkap</p>
              ...
              <div class="card shadow mb-3">
                <div class="row no-gutters">
                  <div class="col-12 col-md-6 col-lg-4">
                    ...
                    <img src="<?php if($field['avatar'] != '') { echo base_url('assets/img/avatar/').$field['avatar']; } else { echo base_url('assets/img/avatar/default.png');}?>" class="card-img profile-pic" alt="default" style="border-radius: calc(.35rem - 1px) 0 0 calc(.35rem - 1px);">
                  </div>
                  <div class="col-12 col-md-6 col-lg-8">
                    ...
                    <div class="card-body">
                      ...
                      <p class="card-text"><a href="<?= base_url();?>Admin/editAnggota/<?=$field['id'];?>" class="btn btn-outline-pink btn-lg">Edit Anggota</a></p>
                      <?php } ?>
                    </div>
                  </div>
                </div>

      ...
      <div class="col-lg-7">
        ...
        <?=form_open_multipart('Admin/updateProfile');?>
          <div class="form-group row">
            ...
            <div class="col-sm-4">
              <input type="hidden" name="id" value="<?=$role['id'];?>" class="form-control" placeholder="Id">
              <input type="text" name="nama_depan" value="<?=$user['nama_depan'];?>" class="form-control" placeholder="Nama Depan" required>
            </div>
            <div class="col-sm-5">
              <input type="text" name="nama_belakang" value="<?=$user['nama_belakang'];?>" class="form-control" placeholder="Nama Belakang" required>
            </div>
          </div>
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <div class="row">
                <div class="col-sm-3">
                  <img src="<?php if($user['avatar'] != ''){ echo base_url('assets/img/avatar/').$user['avatar'];} else{echo base_url('assets/img/avatar/default.png');}?>" class="img-thumbnail">
                  <input type="hidden" name="old_avatar" value="<?=$user['avatar'];?>" class="form-control">
                </div>
                <div class="col-sm-9">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-4">
              <input name="tgl_lahir" value="<?=$user['tgl_lahir'];?>" class="form-control" id="tgl_lahir" placeholder="Tanggal Lahir" required>
            </div>
            <div class="col-sm-5">
              <input type="text" name="tempat_lahir" value="<?=$user['tempat_lahir'];?>" class="form-control" placeholder="Tempat Lahir" required>
            </div>
          </div>
          <div class="form-group row">
            <label for="nickname" class="col-sm-3 col-form-label">Nickname</label>
            <div class="col-sm-9">
              <input type="text" name="nickname" value="<?=$user['nickname'];?>" class="form-control" placeholder="Nickname atau Nama Wibu">
            </div>
          </div>
          <div class="form-group row">
            <label for="gender" class="col-sm-3 col-form-label">Jenis Kelamin</label>
            <div class="col-sm-9">
              <select class="form-control" value="<?=$user['gender'];?>" name="gender" required>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <select class="form-control" value="<?=$user['fakultas'];?>" name="fakultas" required>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input type="text" name="prodi" value="<?=$user['prodi'];?>" class="form-control" placeholder="Program Pendidikan">
            </div>
          </div>
          <div class="form-group row">
            <label for="angkatan" class="col-sm-3 col-form-label">Angkatan</label>
            <div class="col-sm-9">
              <input type="number" name="angkatan" value="<?=$user['angkatan'];?>" class="form-control" placeholder="Tahun Angkatan" required>
            </div>
          </div>
          <div class="form-group row">
            <label for="no_hp" class="col-sm-3 col-form-label">Nomor Handphone</label>
            <div class="col-sm-9">
              <input type="text" name="no_hp" value="<?=$user['no_hp'];?>" class="form-control" placeholder="Nomor Handphone" required>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <select class="form-control" name="divisi" value="<?=$user['divisi'];?>" required>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <textarea name="alamat" class="form-control" placeholder="Alamat rumah" required><?=$user['alamat'];?></textarea>
            </div>
          </div>
          <div class="form-group row">
            <label for="alasan" class="col-sm-3 col-form-label">Alasan</label>
            <div class="col-sm-9">
              <textarea name="alasan" class="form-control" placeholder="Alasan Mendaftar"><?=$user['alasan'];?></textarea>
            </div>
          </div>
